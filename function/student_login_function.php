...
if(isset($_POST['StudentID'])){
	...
	if(mysqli_num_rows($result)>0){
        ...
        $FID=mysqli_query($connect,"SELECT DepartmentID FROM studentdetail WHERE StudentID='".$StudentID."'");
