...
$query = "SELECT * FROM  appointment WHERE approval= 'Approve' and student_id='".$_SESSION['StudentID']."' ";
...
while($row=mysqli_fetch_array($res)){
	...
	echo "<td style='border:2px solid black'>";echo '&nbsp';echo $row["teacher"];echo "</td>";
