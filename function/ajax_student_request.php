...
$query = "SELECT * FROM  formrequest WHERE teacher='". $_SESSION['TeacherName']."'AND request='Pending'" ;
...
while($row=mysqli_fetch_array($res)){
	...
	<input type="button" id="<?php echo $row["sid"]; ?>" name="<?php echo $row["id"];?>" value="Decline" onclick="if (!confirm('Are you sure?')) { return false };decline(this.id)">
	<?php echo '&nbsp';"</td";
	echo"</tr>";
 }
 echo "</table>";
