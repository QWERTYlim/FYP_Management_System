...
if(isset($_POST["query"]))
{
	...
	$query = "SELECT * FROM uploadreport LEFT JOIN studentinfo ON uploadreport.sid=studentinfo.StudentID WHERE filetitle LIKE '%".$search."%'  AND Rating>80
	OR name LIKE '%".$search."%' AND Rating>80 
	OR Sem LIKE '%".$search."%' AND Rating>80 ";
