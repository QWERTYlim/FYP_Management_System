...
<head>
	...
	<button class="blue"><a href="../student/StudentHome.php" class="blue">Home</a></button>
	...
	<div class="container">
		<div class="table-wrapper" style="height:700px;">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-8"><h2>Reference File</h2></div>
				</div>
			</div>
			<table class="table table-bordered">
				<div id="disp_data"></div>
				<script type="text/javascript" src="../js/showUploadFile.js"></script>
			</table>
		</div>
	</div>    
