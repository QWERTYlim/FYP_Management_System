      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
		...
		<div class="table-wrapper" style="margin-left:10px">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-8" style="font-size: 35px;text-align: center;"><STRONG >Rejected Request</strong></div>
			...
			<table class="table table-bordered">
				...
				<script type="text/javascript" src="../js/teacher_show_student_rejected.js"></script>
			</table>
		</div>
	</div>    
    </div>
